    ...
    return (
        <main>
            <Panel classes="flex-col relative z-[1]">
                {/* Header */}
                <Image
                    className="absolute w-full h-24 rounded-sm object-cover"
                    src={user.banner}
                    alt=""
                    width={1000}
                    height={1000}
                ...
                <div className="z-[1] flex flex-col gap-2 p-4">
                    ...
                    <div className="flex flex-row justify-between items-center gap-2 p-2 mt-1">
                        ...
                        {user.uuid === active.uuid ? (
                            <button
                                className="flex flex-row items-center gap-1 bg-gray-100 hover:bg-gray-200 p-1 w-fit text-gray-800 font-regular text-[0.625rem] leading-3 transition-colors duration-200 mr-2"
                    ...
                    {/* Biography */}
                    <p className="text-gray-800 font-light text-[0.625rem] leading-[0.78125rem]">{user.biography}</p>
                    ...
                    <div className="flex flex-wrap gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex flex-row items-center gap-1">
                                ...
                                <h6 className="text-gray-800 font-regular text-[0.625rem] leading-3">
                                    Payment Methods
                                </h6>
                            </div>
