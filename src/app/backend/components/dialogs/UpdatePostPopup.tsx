          ...
          <div className="flex flex-row items-center gap-3">
            <div className="bg-gray-100 rounded-full flex flex-row items-center gap-1 px-2.5 py-0.5 border border-gray-200 h-5">
              ...
              <select
                ...
                className="bg-gray-100 text-gray-800 text-[0.625rem] font-regular cursor-pointer appearance-none w-auto pl-1 h-4 items-center leading-3"
                onChange={handleInputChange}
                required
              >
                <option className="w-full text-gray-500 text-[0.625rem] font-light rounded-sm h-5" value={1}>
                  Article
                </option>
                <option className="w-full text-gray-500 text-[0.625rem] font-light rounded-sm h-5" value={2}>
                  Buying
                </option>
                <option className="w-full text-gray-500 text-[0.625rem] font-light rounded-sm h-5" value={3}>
                  Selling
                </option>
              </select>
